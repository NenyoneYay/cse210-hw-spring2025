public class RepeatQuest : Quest
{
    ...
    private string _questType = "Repeat Quest";

    public RepeatQuest (string questName, string questDescription, int questEXP, int questNumber):base(questName, questDescription, questEXP, questNumber)
    {
